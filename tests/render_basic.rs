...
#[test]
fn should_render_simple_div_when_given_basic_jsx() -> Result<(), Box<dyn std::error::Error>> {
    // Given
...
#[test]
fn should_render_nested_elements_when_given_nested_jsx() -> Result<(), Box<dyn std::error::Error>> {
    // Given
    let source = r"export default function Page() {
...
fn should_render_props_in_text_when_given_jsx_expression_with_props() -> Result<(), Box<dyn std::error::Error>> {
  ...
  return <div>Hello, {props.name}!</div>;
    ...
    // When
    let result = render_string(source, "greeting.jsx", &props, &config)?;
...
#[test]
fn should_render_tsx_source_when_given_tsx_file_name() -> Result<(), Box<dyn std::error::Error>> {
    // Given
    let source = r"
interface Props {
  name: string;
...
export default function Page(props: Props) {
  return <div>{props.name}</div>;
    ...
    // When
    let result = render_string(source, "page.tsx", &props, &config)?;
...
#[test]
fn should_render_arrow_function_default_export() -> Result<(), Box<dyn std::error::Error>> {
    // Given
...
#[test]
fn should_render_anonymous_arrow_default_export() -> Result<(), Box<dyn std::error::Error>> {
    // Given
...
#[test]
fn should_render_anonymous_function_default_export() -> Result<(), Box<dyn std::error::Error>> {
    // Given
...
#[test]
fn should_escape_html_in_text_content() -> Result<(), Box<dyn std::error::Error>> {
    // Given
    let source = r"export default function Page(props) {
...
#[test]
fn should_escape_quotes_in_attribute_values() -> Result<(), Box<dyn std::error::Error>> {
    // Given
    let source = r"export default function Page(props) {
...
#[test]
fn should_render_empty_element_when_given_no_children() -> Result<(), Box<dyn std::error::Error>> {
    // Given
    let source = r"export default function Page() {
  return <div></div>;
}";
